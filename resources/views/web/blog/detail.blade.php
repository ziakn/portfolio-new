                    ...
                    <div class="single-post row">
                        ...
                        <div class="col-lg-3  col-md-3">
                            <div class="blog_info text-right">
                                <div class="post_tag">
                                    <a class="active" href="{{"/blog?category=".$data->category?->slug}}">{{ $data->category?->title }}</a>
                                </div>
                                <ul class="blog_meta list">
                                    {{-- <li><a href="#">Mark wiens<i class="lnr lnr-user"></i></a></li> --}}
                                    <li><a href="#">{{$data->created_at->diffForHumans()}}<i class="lnr lnr-calendar-full"></i></a></li>
                                    <li><a href="#">{{$data->viewed}}<i class="lnr lnr-eye"></i></a></li>
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                ...
                                <div class="media-body">
                                    <a href="{{"/blog/".$item->slug}}"><h3>{{$item->title}}</h3></a>
